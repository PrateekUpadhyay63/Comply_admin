    ...
    return data.map((row, index) => {
      return (
        <TableRow hover role="checkbox" tabIndex={-1} key={index}>
          ...
          <TableCell align="center">
            {row.logoNavigateURL ? <img src={row.logoNavigateURL} alt="logo"/> : ""}
          </TableCell>
          <TableCell align="center">
          ...
          <TableCell align="center" style={{ minWidth: "7rem" }}>
            ...
            <Tooltip title="Edit" >
              ...
              navigate(`${Utils.Pathname.pageInfo}?id=${row.id}`);
            }
            }/>
            </Tooltip>
            <Tooltip title="Delete">
              <ContentCopyIcon
                ...
                color="disabled"
                 onClick={()=>{console.log(row.id,"RIWID")
                  dispatch(deletePAGES(row.id));
          ...
          <TableCell align="center">
          Edit List  U.S. Sourced Income  Form Type
        ...
        <TableContainer style={{ overflowY: "hidden" }}>
          ...
          >
            ...
            <TableBody>
              {/* userData, */}
              {getTableData(
                 pageData.pageData,setOpen, getTeamList,navigate,dispatch)}
            </TableBody>
          </Table>
          <Grid
            container
